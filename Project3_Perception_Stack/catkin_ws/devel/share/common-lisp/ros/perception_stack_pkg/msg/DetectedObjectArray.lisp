...
(cl:defclass <DetectedObjectArray> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (objects
    :reader objects
    :initarg :objects
    :type (cl:vector perception_stack_pkg-msg:DetectedObject)
   :initform (cl:make-array 0 :element-type 'perception_stack_pkg-msg:DetectedObject :initial-element (cl:make-instance 'perception_stack_pkg-msg:DetectedObject))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <DetectedObjectArray>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'DetectedObjectArray)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name perception_stack_pkg-msg:<DetectedObjectArray> is deprecated: use perception_stack_pkg-msg:DetectedObjectArray instead.")))
...
(cl:defmethod objects-val ((m <DetectedObjectArray>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader perception_stack_pkg-msg:objects-val is deprecated.  Use perception_stack_pkg-msg:objects instead.")
  (objects m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <DetectedObjectArray>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'objects)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'perception_stack_pkg-msg:DetectedObject))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<DetectedObjectArray>)))
  ...
  "perception_stack_pkg/DetectedObjectArray")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'DetectedObjectArray)))
  "Returns string type for a message object of type 'DetectedObjectArray"
  "perception_stack_pkg/DetectedObjectArray")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<DetectedObjectArray>)))
  ...
  "c10d2ca229c434ab1484b8d5ff6303b5")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'DetectedObjectArray)))
  "Returns md5sum for a message object of type 'DetectedObjectArray"
  "c10d2ca229c434ab1484b8d5ff6303b5")
